...
foreach($menus as $menu)
{
				...
				echo "<div class='separation'><p class='plat'>Menu : " . $menu['nom'] . " </p>";
				echo "<p class='plat'>Prix : " . $menu['prix'] . '€' . " </p><br />";
				echo "<p class='plat'><img src='./assets/img/" . $menu['image'] . "' </p><br />";
				echo "<p class='plat'><a href='updateMenu.php?idMenu=" . $menu['ID'] . "'><input type='submit' value='Modifier' class='button' name='idMenu'></a>";
				echo "<a href='supprimerMenu.php?idMenu=" . $menu['ID'] . "'><input type='submit' value='Supprimer' class='button' name='idMenu'></a></p></div>";
				...
				{
	 				echo "<p class='plat'>Plat composant le menu " . $menu['nom'] . " : <br />" . $plat['nom'] . " </p>";
	 				echo "<p class='plat'>Prix : " . $plat['prix'] . " € </p><br />";
	        echo "<p class='plat'><a href='updatePlat.php?idPlat=" . $plat['ID'] . "&idMenu=" . $menu['ID'] . "'><input type='submit' value='Modifier' class='button' name='idPlat'></a>";
