...
$requete = $bdd->prepare('SELECT * FROM menus WHERE ID = :id_menus'); // :id_plats est inventé ici, il doit crspdre au 2ème paramètre de bindParam
...
while ($donnees = $requete->fetch())
{
  ...
  echo "<div class='plat'>
    <form method='post' action='traitementUpdateMenu.php?idMenu=".$idMenu."' enctype='multipart/form-data'>
      <p>
