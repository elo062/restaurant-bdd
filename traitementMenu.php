...
$req = $bdd->prepare('INSERT INTO menus(nom, prix, image) VALUES(:nom, :prix, :image)');
$req->execute(array(
	'nom' => $nom,
	'prix' => $prix,
	'image' => $image
...
foreach($tableauPlats as $plat)
{
	// intval = on transforme en chiffre
	$plat = intval($plat);
